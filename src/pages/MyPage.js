...
const MyPage = (props) => {
  ...
  console.log(user_profile.profileImg === null)
  ...
  return (
    ...
    <Grid >
      ...
      <Grid minHeight='calc( 100vh - 124px )'>
          ...
          ? <Grid>
              <Grid display='flex' justify='space-between' margin='30px 0 22px'>
                ...
                <Grid padding='12px 0' margin='0 18px 0 0'>
                  <Text bold size='18px' line>로그인이 필요합니다.</Text>
                </Grid>

                <Grid padding='6px 0 0'>
                  <Grid cursor width='66px' padding='5px 6px' bg='#FFF' radius='4px' align='center'
              ...
              <div style={{border: '1px solid #adb6c1', margin: '0 0 22px'}}></div>
            </Grid>
            // 로그인 했을 때
          : <Grid>
              <Grid display='flex' justify='space-between' margin='30px 0 22px'>
                <Grid width='75px' height='75px'>
                  <Image
                    width='75px' height='75px' size='cover' radius='999px'
                    src={user_profile.profileImg === null? basicProfile: user_profile.profileImg} 
                  />
                </Grid>
        ...
        <Grid height='800px' bg='#FFF' radius='22px 22px 0 0' padding='16px 16px 0'>
