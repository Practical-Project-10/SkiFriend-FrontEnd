    ...
    <React.Fragment>
        <Grid>
          ...
          <Grid className='signupBox'>
            ...
            <Grid className='dup'>
              <Input _name='nickname' _onBlur={handleBlur} label='닉네임' type='text'/>
              <Button className='dupButton'>중복확인</Button>
            </Grid>
            <Input _name='pwd' _onBlur={handleBlur} label='비밀번호' type='password'/>
            <Input _name='rePwd' _onBlur={handleBlur} label='비밀번호 확인' type='password'/>
          </Grid>
